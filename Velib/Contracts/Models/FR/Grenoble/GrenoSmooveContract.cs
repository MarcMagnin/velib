...
namespace Velib.Contracts.Models.Greno.Smoove
{
    // New York
    public class GrenoSmooveContract: Contract
    {
        [IgnoreDataMember]
        private CancellationTokenSource tokenSource;
        [IgnoreDataMember]
        private Task Updater;
        public GrenoSmooveContract()
        {
        ...
        {
            return (GrenoSmooveContract)base.GetSimpleContract();
        }

        protected override Contract GetInstanceForSimpleClone()
        {
            return new GrenoSmooveContract();
        }
    }
}
